...
WScript.sleep(1000); WshShell.Run('cmd /C TITLE blank & TIMEOUT /nobreak 10000');

for (var i = 0; i < startLetters.length; i++) {
	for (var j = 0; j < endLetters.length; j++) {
		                     //Start Chrome
		WScript.sleep(1000); WshShell.Run('cmd /C "C:/Users/Alex/Documents/Programs/Chrome Portable/Google Chrome Portable 1/GoogleChromePortable.exe"');
		                     WScript.sleep(5000);
		...
		WScript.sleep(1000); WshShell.SendKeys("/{ENTER}");
		                     WScript.sleep(10000);
		                     //Select and copy
		WScript.sleep(1000); WshShell.AppActivate("blank");
		WScript.sleep(1000); WshShell.AppActivate("New Tab - Google Chrome");
		//WScript.sleep(1000); WshShell.SendKeys("{TAB}");
		                     WScript.sleep(10000);
		WScript.sleep(1000); WshShell.SendKeys("{F6}");
		WScript.sleep(1000); WshShell.SendKeys("{F6}");
		WScript.sleep(1000); WshShell.SendKeys("{F6}");
		WScript.sleep(1000); WshShell.SendKeys("{DOWN}");
		...
		WScript.sleep(1000); WshShell.AppActivate("PasteArea.txt - Notepad");
		                     //Clear file
		WScript.sleep(1000); WshShell.SendKeys("^A");
		WScript.sleep(1000); WshShell.SendKeys("{BACKSPACE}");
		                     //Paste
		WScript.sleep(1000); WshShell.SendKeys("^V");
		//WScript.sleep(1000); WshShell.SendKeys("^S"); //This doesn't work for some reason
		                     //Close and save PasteArea.txt
		WScript.sleep(1000); WshShell.SendKeys("%{F4}");
		WScript.sleep(1000); WshShell.SendKeys("{ENTER}");
